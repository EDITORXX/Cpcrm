...
@section('title', 'Leads - Sales Manager')
...
<script>
        ...
        content.innerHTML = `
            <form id="siteVisitForm" class="space-y-4">
                ...
                <div>
                    ...
                    <textarea id="siteVisitPropertyAddress" rows="2"
    ...
    async function submitCreateSiteVisit() {
        ...
        const visitData = {
            ...
            property_address: document.getElementById('siteVisitPropertyAddress').value || null,
