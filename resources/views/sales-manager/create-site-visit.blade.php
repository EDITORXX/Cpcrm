...
@section('title', 'Create Site Visit - Sales Manager')
...
<div class="form-container">
    <h2 class="text-2xl font-bold text-gray-900 mb-6">Schedule New Site Visit</h2>
    ...
    <form id="siteVisitForm" enctype="multipart/form-data">
        ...
        <div style="display: flex; gap: 10px; margin-top: 24px;">
            <button type="submit" class="btn btn-primary">
                <i class="fas fa-calendar-check mr-2"></i>Schedule Site Visit
            </button>
