...
<body>
    ...
    <aside class="fixed left-0 top-0 h-full w-64 bg-white border-r border-gray-200 shadow-sm z-30" style="overflow-y: auto;">
        <div style="padding: 20px; margin-bottom: 30px;">
            ...
            <p style="font-size: 12px; color: #B3B5B4;">Sales Manager</p>
        </div>
        <nav style="padding: 0 20px;">
            ...
            <a href="{{ route('sales-manager.leads') }}" class="sidebar-link {{ request()->routeIs('sales-manager.leads') ? 'active' : '' }}">
            ...
            <a href="{{ route('sales-manager.prospects') }}" class="sidebar-link {{ request()->routeIs('sales-manager.prospects') ? 'active' : '' }}">
                <i class="fas fa-star" style="margin-right: 10px; width: 20px;"></i>
                Prospects
            </a>
            ...
            {{-- <a href="{{ route('sales-manager.reports') }}" class="sidebar-link {{ request()->routeIs('sales-manager.reports') ? 'active' : '' }}">
    ...
    <div style="margin-left: 256px; min-height: 100vh;">
        <div class="container">
            ...
            <div class="header">
                <div>
                    <h1 style="font-size: 28px; font-weight: 700; color: #063A1C;">@yield('page-title', 'Sales Manager')</h1>
                </div>
