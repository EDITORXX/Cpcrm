...
@section('title', 'Edit Requirements - ' . $lead->name)
@section('page-title', 'Edit Requirements')
@section('page-subtitle', 'Update lead requirements')
...
<div class="max-w-6xl mx-auto">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        @include('leads.partials.centralized-form', ['lead' => $lead, 'showBasicInfo' => false])
    </div>
</div>
@endsection
