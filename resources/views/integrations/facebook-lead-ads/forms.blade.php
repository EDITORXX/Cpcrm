...
<div class="max-w-3xl mx-auto">
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6">
        <h2 class="text-xl font-semibold text-gray-900 mb-2">Lead Gen forms</h2>
            ...
            <ul class="space-y-3">
                @foreach($forms as $form)
                    ...
                    <li class="flex items-center justify-between p-4 border border-gray-200 rounded-lg hover:bg-gray-50">
                        ...
                        <a href="{{ route('integrations.facebook-lead-ads.mapping', ['formId' => $metaId, 'form_name' => $name, 'page_id' => request()->query('page_id')]) }}" class="px-3 py-1.5 bg-gradient-to-r from-[#063A1C] to-[#205A44] text-white rounded-lg text-sm hover:from-[#205A44] hover:to-[#15803d]">
