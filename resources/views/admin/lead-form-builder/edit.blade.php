            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                    ...
                    <select name="field_level" id="field_level" required
                        ...
                        <option value="telecaller" {{ old('field_level', $leadFormField->field_level) == 'telecaller' ? 'selected' : '' }}>Sales Executive</option>
                        <option value="sales_executive" {{ old('field_level', $leadFormField->field_level) == 'sales_executive' ? 'selected' : '' }}>Sales Executive</option>
                        <option value="sales_manager" {{ old('field_level', $leadFormField->field_level) == 'sales_manager' ? 'selected' : '' }}>Sales Manager</option>
                    </select>
                </div>
            </div>
